...
public class CommandCustomXboxController extends CommandXboxController {
  private static final double kTriggerPressedThreshold = 0.15;
  private static final double kControllerDeadband = 0.1;
   ...
   *
   * @see #kTriggerPressedThreshold
   */
  @Override
  public Trigger leftTrigger() {
    return leftTrigger(kTriggerPressedThreshold);
  }
  ...
  public Trigger rightTrigger() {
    return rightTrigger(kTriggerPressedThreshold);
  }
  ...
  private double applyJoystickDeadband(double stickValue) {
    return MathUtil.applyDeadband(stickValue, kControllerDeadband);
  }
}
